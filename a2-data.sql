...
insert into users values ('davood@ggg.com', 'davo', sysdate);
insert into users values ('david@ggg.com', 'davi', sysdate);
insert into users values ('gandalf@wizard.com', 'gand', sysdate);
insert into users values ('ralph@ggg.com', 'ralp', sysdate);
insert into users values ('uematsu@ff.com', 'uema', sysdate);
insert into users values ('bill@ggg.com', 'bill', sysdate);
insert into users values ('jack@ggg.com', 'jack', sysdate);
insert into users values ('greg@ggg.com', 'greg', sysdate);
insert into users values ('thorin@ggg.com', 'thor', sysdate);
insert into users values ('elrond@ggg.com', 'elro', sysdate);
insert into users values ('john@ggg.com', 'john', sysdate);
insert into users values ('man@ggg.com', 'man', sysdate);
insert into users values ('dude@ggg.com', 'dude', sysdate);
insert into users values ('person@ggg.com', 'pers', sysdate);
